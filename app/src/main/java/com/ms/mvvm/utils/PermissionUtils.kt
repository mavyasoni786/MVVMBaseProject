...
//            }
//        }
//        val array = arrayOfNulls<String>(arrPermission.size)
//        arrPermission.toArray(array)
//        return array
//    }
    ...
    fun checkPermissions(permissionList: ArrayList<String>): Array<String> {
        ...
        return arrPermission.toTypedArray() as Array<String>
    }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        when (requestCode) {
            Constant.REQUEST_CODE_ASK_PERMISSIONS -> if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                if (permissionGranted != null) {
                    permissionGranted!!.onPermissionGranted(requestCode)
                }
            } else {
                Trace.toast("Warning!!! Some feature of application will not work correctly if you disallow the permission.")
            }
        }
    }
